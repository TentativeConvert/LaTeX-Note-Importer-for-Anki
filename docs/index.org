...
*** Preamble<<import-preamble>>
    ...
    For example, in order to turn our [[minexample][minimal example]] into a minimal working example, you need to edit the =Header= and =Footer= in this dialog as follows:
